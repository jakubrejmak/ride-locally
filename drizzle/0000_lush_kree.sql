...
ALTER TABLE "trips" ADD CONSTRAINT "trips_calendar_id_calendar_id_fk" FOREIGN KEY ("calendar_id") REFERENCES "public"."calendar"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
CREATE INDEX "addresses_spatial_idx" ON "addresses" USING gist ("coordinates");--> statement-breakpoint
CREATE INDEX "stops_spatial_idx" ON "stops" USING gist ("coordinates");